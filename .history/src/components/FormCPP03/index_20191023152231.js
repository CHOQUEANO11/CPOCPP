...
export default function Potentials() {
  ...
  return (
    <Container>
      ...
      <h4 style={{ textAlign: 'center' }}>
        1.1 - Tempo exercendo função fora da PMPA, mas de natureza PM (por ano)
      </h4>
      ...
      <Grid container spacing={1}>
        <Grid item xs={12}>
          <Paper className={classes.paper} style={{ textAlign: 'center' }}>
            2. ATIVIDADES ACADÊMICAS E DE PESQUISAS INSTITUCIONAIS NA GRADUAÇÃO
            ATUAL
          </Paper>
        </Grid>
      </Grid>
      <h4 style={{ textAlign: 'center' }}>
        2.1 - Obras literárias e manuais profissionais homologados e editados ou
        artigos cientificos publicados, afetos à Defesa Social
      </h4>
