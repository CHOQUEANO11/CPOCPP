  ...
  return (
    <Container>
      ...
      <Form>
        ...
        <Grid container spacing={1}>
          <Grid item xs={6}>
            <Paper className={classes.paper}>Total de Pontos positivos:</Paper>
          </Grid>
          <Grid item xs={6}>
            <Paper className={classes.paper}>Total de Pontos negativos:</Paper>
          </Grid>
        </Grid>
        <Grid container spacing={1}>
          <Grid item xs={12}>
            <Paper className={classes.paper}>Resultado total: </Paper>
          </Grid>
        </Grid>
