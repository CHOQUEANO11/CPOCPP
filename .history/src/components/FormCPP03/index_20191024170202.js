    ...
    <Container>
      ...
      <Form>
        ...
        <Grid container spacing={1}>
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={omgp.mb}
                      onChange={() =>
                        setCfp({ mb: true, b: false, value: 0.2 })
                      }
                      value={false}
                    />
                  }
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Ordem do Mérito Cel Fontoura - Total:
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Gen. Ferreira Coelho 1 Rosa Heráldica - Total:
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Gen. Ferreira Coelho 2 Rosa Heráldica - Total:
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Gen. Ferreira Coelho 3 Rosa Heráldica - Total:
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Tempo de serviço 10 anos - Total:
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Tempo de serviço 20 anos - Total:
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
