...
export default function App() {
  ...
  const [feeo, setFeeo] = useState(check);
  const [valueFeeo, setValueFeeo] = useState(0);
    ...
    <Container>
      ...
      <Form>
        ...
        <Grid container spacing={1}>
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Capacidade de Raciocínio e Decisão - Peso: {valueCrd}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Facilidade de Expressão (escrita/oral) - Peso: {valueFe}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
        ...
        <Grid container spacing={1}>
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Cumprimento do Dever - Peso: {valueCd}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Espirito de Disciplina - Peso: {valueEd}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Correção de Atitude - Peso: {valueCa}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Assiduidade e Pontualidade - Peso: {valueAp}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Espirito de camaradagem e Relações Humanas - Peso: {valueEcrh}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Capacidade de Liderança - Peso: {valueCl}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Capacidade de Planejamento - Peso: {valueCp}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Facilidade de Expressão (escrita/oral) - Peso: {valueFeeo}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={feeo.checkedE}
                      onChange={() =>
                        setFeeo({
                          checkedE: true,
                          checkedMB: false,
