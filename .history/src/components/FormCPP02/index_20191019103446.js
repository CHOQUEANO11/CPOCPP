...
export default function App() {
  ...
  const [valueDt, setValueDt] = useState(0);
    ...
    <Container>
      ...
      <Form>
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              18 - Disposição para o Trabalho - Peso: {valueDt}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              TOTAL DE CONCEITOS MARCADOS: {valueLav.click + valueNr.click}
            </Paper>
          </Grid>
          <Grid item xs={3}>
            <Paper className={classes.paper}>
              ...
              {parseFloat(
                (
                  (valueLav.peso +
                    ...
                    valueRf +
                    valueDt) /
                  (valueLav.click + valueNr.click + valueCfs.click)
                ).toFixed(2)
              )}
            </Paper>
          </Grid>
