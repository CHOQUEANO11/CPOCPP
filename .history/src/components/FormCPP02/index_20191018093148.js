...
export default function App() {
  ...
  const check = {
    checkedE: { decision: false, value: 10 },
    checkedMB: { decision: false, value: 8 },
    checkedB: { decision: false, value: 7 },
    checkedR: { decision: false, value: 5 },
    checkedI: { decision: false, value: 3 },
    checkedNO: { decision: false, value: 0 }
  };

  const [lav, setLav] = useState(check);
  const [nr, setNr] = useState(check, value: 0);
    ...
    <Container>
      ...
      <Form>
        ...
        <Grid container spacing={1}>
            ...
            <Paper className={classes.paper}>
              ...
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={lav.checkedE.decision}
                      onChange={() =>
                        setLav({
                          checkedE: { decision: true },
                          checkedMB: { decision: false },
                          checkedB: { decision: false },
                          checkedI: { decision: false },
                          checkedR: { decision: false },
                          checkedNO: { decision: false },
                          value: nr.checkedE.value
                        })
                      }
                      value={false}
                    />
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={lav.checkedMB.decision}
                      onChange={() =>
                        setLav({
                          checkedE: { decision: false },
                          checkedMB: { decision: true },
                          checkedB: { decision: false },
                          checkedI: { decision: false },
                          checkedR: { decision: false },
                          checkedNO: { decision: false },
                          value: nr.checkedMB.value
                        })
                      }
                      value={false}
                    />
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={lav.checkedB.decision}
                      onChange={() =>
                        setLav({
                          checkedE: { decision: false },
                          checkedMB: { decision: false },
                          checkedB: { decision: true },
                          checkedI: { decision: false },
                          checkedR: { decision: false },
                          checkedNO: { decision: false },
                          value: nr.checkedB.value
                        })
                      }
                      value={false}
                    />
                    ...
                    <Checkbox
                      ...
                      onChange={() =>
                        setLav({
                          ...
                          checkedB: { decision: false },
                          checkedI: { decision: false },
                          checkedR: { decision: true },
                          checkedNO: { decision: false },
                          value: nr.checkedR.value
                        })
                      }
                      value={false}
                    />
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={lav.checkedI.decision}
                      onChange={() =>
                        setLav({
                          checkedE: { decision: false },
                          checkedMB: { decision: false },
                          checkedB: { decision: false },
                          checkedI: { decision: true },
                          checkedR: { decision: false },
                          checkedNO: { decision: false },
                          value: nr.checkedI.value
                        })
                      }
                      value={false}
                    />
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={lav.checkedNO.decision}
                      onChange={() =>
                        setLav({
                          checkedE: { decision: false },
                          checkedMB: { decision: false },
                          ...
                          checkedI: { decision: false },
                          checkedR: { decision: false },
                          checkedNO: { decision: true },
                          value: nr.checkedNO.value
                        })
                      }
                      value={false}
                    />
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Noções de Responsabilidade {nr.value}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={nr.checkedE.decision}
                      onChange={() =>
                        setNr({
                          checkedE: { decision: true },
                          checkedMB: { decision: false },
                          ...
                          checkedR: { decision: false },
                          checkedNO: { decision: false },
                          value: parseInt(nr.checkedE.value)
                        })
                      }
                      value={false}
                    />
                    ...
                    <Checkbox
                      ...
                      onChange={() =>
                        setNr({
                          ...
                          checkedR: { decision: false },
                          checkedNO: { decision: false },
                          value: parseInt(nr.checkedMB.value)
                        })
                      }
                      value={false}
                    />
                    ...
                    <Checkbox
                      ...
                      onChange={() =>
                        setNr({
                          ...
                          checkedR: { decision: false },
                          checkedNO: { decision: false },
                          value: parseInt(nr.checkedB.value)
                        })
                      }
                      value={false}
                    />
                    ...
                    <Checkbox
                      ...
                      onChange={() =>
                        setNr({
                          ...
                          checkedR: { decision: true },
                          checkedNO: { decision: false },
                          value: parseInt(nr.checkedR.value)
                        })
                      }
                      value={false}
                    />
                    ...
                    <Checkbox
                      ...
                      onChange={() =>
                        setNr({
                          ...
                          checkedR: { decision: false },
                          checkedNO: { decision: false },
                          value: parseInt(nr.checkedI.value)
                        })
                      }
                      value={false}
                    />
                    ...
                    <Checkbox
                      ...
                      onChange={() =>
                        setNr({
                          ...
                          checkedR: { decision: false },
                          checkedNO: { decision: true },
                          value: parseInt(nr.checkedNO.value)
                        })
                      }
                      value={false}
                    />
