      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            <p>
              B - Peso (4) => BOM: Demonstra capacidade em executar as
              atividades relacionadas à habilidade, competências e valores
              avaliados, praticando-as com certa frequência
            </p>
            <p>
            ...
            <p>
              I - Peso (1) => INSUFICIENTE: Não demonstra(ou raramente
              demonstra) possuir capacidade em executar as atividades
              relacionadas à habilidade, competência e valores avaliados e
              raramente as pratica.
            </p>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={handleChange('checkedMB')}
                    value="checkedMB"
                  />
                }
                label="MB"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={handleChange('checkedNO')}
                    value="checkedNO"
                  />
                }
                label="NO"
          ...
          <Paper className={classes.paper}>
            ...
            <FormGroup row style={{ justifyContent: 'center' }}>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state2.checke2}
                    onChange={handleChange('checke2')}
                    value="checke2"
                  />
                }
                label="MB"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state2.checke6}
                    onChange={handleChange('checke6')}
                    value="check6"
                  />
                }
                label="NO"
          ...
          <Paper className={classes.paper}>
            ...
            <FormGroup row style={{ justifyContent: 'center' }}>
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state3.check7}
                    onChange={handleChange('check7')}
                    value="check7"
                  />
                }
                label="E"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state3.check8}
                    onChange={handleChange('check8')}
                    value="check8"
                  />
                }
                label="MB"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state3.check9}
                    onChange={handleChange('check9')}
                    value="check9"
                  />
                }
                label="B"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state3.check10}
                    onChange={handleChange('check10')}
                    value="check10"
                  />
                }
                label="R"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state3.check11}
                    onChange={handleChange('check11')}
                    value="check11"
                  />
                }
                label="I"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state3.check12}
                    onChange={handleChange('check12')}
                    value="check12"
                  />
                }
                label="NO"
          ...
          <Paper className={classes.paper}>
            ...
            <FormGroup row style={{ justifyContent: 'center' }}>
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state4.check13}
                    onChange={handleChange('check13')}
                    value="check13"
                  />
                }
                label="E"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state4.check14}
                    onChange={handleChange('check14')}
                    value="check14"
                  />
                }
                label="MB"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state4.check15}
                    onChange={handleChange('check15')}
                    value="check15"
                  />
                }
                label="B"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state4.check16}
                    onChange={handleChange('check16')}
                    value="check16"
                  />
                }
                label="R"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state4.check17}
                    onChange={handleChange('check17')}
                    value="check17"
                  />
                }
                label="I"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state4.check18}
                    onChange={handleChange('check18')}
                    value="check18"
                  />
                }
                label="NO"
          ...
          <Paper className={classes.paper}>
            ...
            <FormGroup row style={{ justifyContent: 'center' }}>
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state5.check19}
                    onChange={handleChange('check19')}
                    value="check19"
                  />
                }
                label="E"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state5.checke20}
                    onChange={handleChange('checke20')}
                    value="checke20"
                  />
                }
                label="MB"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state5.check21}
                    onChange={handleChange('check21')}
                    value="check21"
                  />
                }
                label="B"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state5.check22}
                    onChange={handleChange('check22')}
                    value="check22"
                  />
                }
                label="R"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state5.check23}
                    onChange={handleChange('check23')}
                    value="check23"
                  />
                }
                label="I"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state5.check24}
                    onChange={handleChange('check24')}
                    value="check24"
                  />
                }
                label="NO"
          ...
          <Paper className={classes.paper}>
            ...
            <FormGroup row style={{ justifyContent: 'center' }}>
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state6.check25}
                    onChange={handleChange('check25')}
                    value="check25"
                  />
                }
                label="E"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state6.check26}
                    onChange={handleChange('check26')}
                    value="check26"
                  />
                }
                label="MB"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state6.check27}
                    onChange={handleChange('check27')}
                    value="check27"
                  />
                }
                label="B"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state6.check28}
                    onChange={handleChange('check28')}
                    value="check28"
                  />
                }
                label="R"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state6.check29}
                    onChange={handleChange('check29')}
                    value="check29"
                  />
                }
                label="I"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state6.check30}
                    onChange={handleChange('check30')}
                    value="check30"
                  />
                }
                label="NO"
          ...
          <Paper className={classes.paper}>
            ...
            <FormGroup row style={{ justifyContent: 'center' }}>
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state7.check31}
                    onChange={handleChange('check31')}
                    value="check31"
                  />
                }
                label="E"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={state7.checke32}
                    onChange={handleChange('checke32')}
                    value="checke32"
                  />
                }
                label="MB"
