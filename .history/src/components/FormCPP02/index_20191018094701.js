                    ...
                    <Checkbox
                      ...
                      onChange={() =>
                        setNr({
                          ...
                          checkedR: { decision: false },
                          checkedNO: { decision: false }
                        }) + setValueLav(nr.checkedMB.valor)
                      }
                      value={false}
                    />
                  }
                    ...
                    <Checkbox
                      ...
                      onChange={() =>
                        setNr({
                          ...
                          checkedR: { decision: false },
                          checkedNO: { decision: true }
                        }) + setValueLav(nr.checkedNO.valor)
                      }
                      value={false}
                    />
                  }
