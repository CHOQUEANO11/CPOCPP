...
export default function App() {
  ...
  const check = {
    checkedE: { decision: false, valor: 10 },
    checkedMB: { decision: false, valor: 8 },
    checkedB: { decision: false, valor: 7 },
    checkedR: { decision: false, valor: 5 },
    checkedI: { decision: false, valor: 3 },
    checkedNO: { decision: false, valor: 0 }
  };
