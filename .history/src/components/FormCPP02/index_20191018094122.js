    ...
    <Container>
      ...
      <Form>
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={6}>
            <Paper className={classes.paper}>
              Noções de Responsabilidade {valueLav}
              <FormGroup row style={{ justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={() =>
                        ...
                        }) + setValueLav(nr.checkedMB.value)
                      }
                      value={false}
                    />
                  }
                    ...
                    <Checkbox
                      ...
                      onChange={() =>
                        setNr({
                          ...
                          checkedR: { decision: false },
                          checkedNO: { decision: true }
                        }) + setValueLav(nr.checkedNO.value)
                      }
                      value={false}
                    />
                  }
