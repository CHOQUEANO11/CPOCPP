        ...
        {!card && (
          <>
            <Form>
              <div>
                ...
                <TextField
                  ...
                  margin="normal"
                  variant="outlined"
                  onClick={() => information(person.Condecoracoes)}
                />
                <TextField
                  id="outlined-name"
                  label="Qtd Elogio"
            ...
            <TextField
              ...
              value={infoCard.map(
                item =>
                  `${item.doc_pub} _____________________FIM_________________________`
              )}
              InputLabelProps={{
                shrink: true
              }}
