...
export default function Compete() {
  ...
  async function handleSerachId(e) {
    const elogio = api.get(`api/v1/pessoa/elogio/id/${e}`);

    const punicao = api.get(`${server}/api/v1/pessoa/punicao/id/${e}`);

    const tempo = api.get(`${server}/api/v1/pessoa/tempo/id/${e}`);
  }
