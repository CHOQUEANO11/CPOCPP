...
export default function Compete() {
  ...
  function listItems(people, pageActual, limitItems) {
    console.log(people, pageActual, limitItems);
    const result = [];
    const totalPages = Math.ceil(people.length / limitItems);
  ...
  return (
    <>
      ...
      <Container>
        ...
        <button onClick={() => listItems(people, 1, 10)} type="button">
          teste {totalPage}
        </button>
      </Container>
    </>
