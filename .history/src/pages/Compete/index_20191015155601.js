...
export default function Compete() {
  ...
  async function addLimitVacancy() {
    console.log(
      parseInt(person.idpessoa),
      parseInt(person.SiglaUnidade),
      parseInt(person.idgraduacao),
      person.Graduacao.graduacao
    );
    const response = await apiInternal.post('compete', {
      idpessoa: parseInt(person.idpessoa),
      idunidade: parseInt(person.SiglaUnidade),
      idgraduacao: parseInt(person.idgraduacao),
    ...
    if (response) {
      ...
      toast.error('Não foi possível adicionar o militar');
    }
  }
